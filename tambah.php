...
<head>
    ...
    <title> Tambah | Data Siswa | CRUD PHP</title>
</head>
<body>
    <!-- Navbar -->
            ...
            <div class="col-md">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nama" name="nis" placeholder="Nis" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="tmpt_lahir" name="tmpt_lahir" placeholder="Tempat Lahir" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="tgl_lahir" class="form-label">Tanggal Lahir</label>
                        <input type="date" class="form-control w-50" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir" required>
                    </div>
                    <div class="mb-3">
