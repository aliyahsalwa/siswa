...
<body>
    ...
    <div class="container">
       ...
       <div class="row">
        <div class="col-md">
            <a href="tambah.php" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mdlAdd"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Siswa</a>
            <a href="#" class="btn btn-success us-1" target="_blank"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Ekxpor ke Excel</a>
        </div>
       </div>
       <div class="row my-5">
            <div class="col-md">
